...
for room in testingrooms:
    os.chdir('C:/Users/rebekah/Documents/GitHub/ps2-rbreuben')
    filepath = os.path.join('testingroom'+room, 'experiment_data.csv')
    newpath = os.path.join('rawdata', 'experiment_data_'+room+'.csv')
...
data = np.empty((0,5))
for room in testingrooms:
    os.chdir('C:/Users/rebekah/Documents/GitHub/ps2-rbreuben/rawdata')
...
#
print('\nOVERALL: {:.2f}%, {:.2f} ms'.format(100*acc_avg,mrt_avg))
print('\nWORDS: {:.2f}%, {:.2f} ms'.format(100*word_acc_avg,word_mrt_avg))
print('\nFACES: {:.2f}%, {:.2f} ms'.format(100*face_acc_avg,face_mrt_avg))
print('\nWHITE/PLEASANT: {:.2f}%, {:.2f} ms'.format(100*acc_wp,mrt_wp))
print('\nBLACK/PLEASANT: {:.2f}%, {:.2f} ms'.format(100*acc_bp,mrt_bp))
print('\nWORDS - WHITE/PLEASANT: {:.2f} ms'.format(words_wp_mrt))
print('\nWORDS - BLACK/PLEASANT: {:.2f} ms'.format(words_bp_mrt))
print('\nFACES - WHITE/PLEASANT: {:.2f} ms'.format(faces_wp_mrt))
print('\nFACES - BLACK/PLEASANT: {:.2f} ms'.format(faces_bp_mrt))
